package prog3.tema00.resueltos.ej04_concurrencia;
...
public class ErrorAccesoConcurrente {
	...
	// Utilizamos la estructura Vector porque es síncrona y solo se puede modificar de uno e uno. Con ArrayList teníamos errores al poder ser modificada en paralelo por varios hilos.
	private static Vector<Long> listaNums = new Vector<>();
	
	//POSIBLE SOLUCIÓN PARA USAR ARRAYLIST - Convierte la implementación de este en síncrona (synchronized). Solo se podrá entrar de 1 en 1 a este método para evitar errores.
