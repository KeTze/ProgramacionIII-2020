...
public class EjemploFicheros {
	 ...
	 * @return	Lista de usuarios del fichero, s�lo formada por los usuarios le�dos correctamente
	 */
	 ...
	 * en formato de datos de usuario separado por comas (una l�nea por usuario)
	 * @param nomFic	Nombre de fichero
	 ...
	 * @return	N�mero de registros a�adidos
	 */
	 ...
	 * @param sentSelect	Sentencia SQL de selecci�n (ejemplo: "nombre = 'buzz'")
